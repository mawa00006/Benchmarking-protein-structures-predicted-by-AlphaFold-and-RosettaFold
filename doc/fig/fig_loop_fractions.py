...
hist, bin_edges, _ = ax1.hist(percentages, bins=num_bins, range=(0, 1), edgecolor='black')


# Add labels and title
ax1.set_ylabel('Frequency')
ax1.set_xlabel(' a) Fraction of loops in longest chain of each structure')
...
ax2.text(6, y_max*0.85, 'Median: 5')
