...
data = pd.read_csv('../../src/results/results.csv')

df = data[data["Model"] == "AlphaFold"]
...
# Save the plot
plt.savefig("pdf/fig_1_loop_fractions_relative_to_adjacentSSE.pdf", dpi=300)
plt.savefig("png/fig_1_loop_fractions_relative_to_adjacentSSE.png", dpi=300)
